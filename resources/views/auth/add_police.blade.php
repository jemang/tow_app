              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form method="post" action="/add/station" class="form-horizontal form-label-left" novalidate>
                      {!! csrf_field() !!}
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="s_name" required="required"  placeholder="station name" type="text">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="phone" name="s_phone" placeholder="phone number" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
                        <label for="password" class="control-label col-md-3">Address</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="address" type="text" name="s_add" placeholder="address" class="form-control col-md-7 col-xs-12" required="required">
                        </div>
